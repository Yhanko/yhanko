...
import Student from '../../../../public/Abou-us-Video(1).png';

export function ContentWho(){
    return(
        <div className='flex flex-row w-screen h-[400px]'>
            <div className='flex flex-col ml-16 w-[38rem] h-[32rem]'>
                ...
                <h2 className='font-bold text-[2.2rem] text-justify text-[#1A202C] mt-4'>Qual é o nosso objectivo<br/> contigo</h2>
                ...
                <div className='flex flex-col mt-[9rem] w-[4rem]'>
                    <span className='fent-bold text-[2.2rem] text-[#57007B]'>1</span>
                    <div className='w-[4rem] h-1 bg-[#57007B] bg-gradient-to-r from-[#57007B] to-[#F76680]'></div>
                </div>
            </div>

            <Image src={Student} alt='Imagem' className='h-[23rem] w-[40rem] rounded-md'/>
        </div>
    )
}